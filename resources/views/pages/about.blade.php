                ...
                <ul class="minicart-product-list">
                    <li>
                        <a href="single-product.html" class="image"><img
                                src="{{ asset('site/images/product-image/1.webp') }}" alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img
                                src="{{ asset('site/images/product-image/2.webp') }}" alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img
                                src="{{ asset('site/images/product-image/3.webp') }}" alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <div class="about-wrapper text-center">
                        <div class="about-contant">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                ...
                                exercitation ullamco laboris nisi ut aliquip ex ea comml consequat. Duis aute irure
                                dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
                                Excepteur sint occaecat cupidatat non proident sunt in culpa</p>
                        </div>
                        <div class="promo-video">
                            <img src="{{ asset('site/images/about/promo-video-img.webp') }}" alt="">
        ...
        <div class="container">
            ...
            <div class="row mb-n-30px">
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-lm-30px mb-lg-30px mb-md-30px">
                    ...
                    <div class="team-wrapper ">
                        <div class="team-image overflow-hidden">
                            <img src="{{ asset('site/images/team/1.webp') }}" alt="">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-lm-30px mb-lg-30px mb-md-30px">
                    ...
                    <div class="team-wrapper">
                        <div class="team-image overflow-hidden">
                            <img src="{{ asset('site/images/team/2.webp') }}" alt="">
                            <ul class="team-social d-flex">
                                <li>
                                    <a class="m-0" title="Twitter" target="_blank" rel="noopener noreferrer"
                                        href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                ...
                <div class="col-xl-4 col-lg-4 col-sm-6 col-md-6 mb-lm-30px ">
                    ...
                    <div class="team-wrapper">
                        <div class="team-image overflow-hidden">
                            <img src="{{ asset('site/images/team/3.webp') }}" alt="">
                            <ul class="team-social d-flex">
                                <li>
                                    <a class="m-0" title="Twitter" target="_blank" rel="noopener noreferrer"
                                        href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
        ...
        <div class="container">
            <div class="feature-wrapper">
                <div class="single-feture-col mb-md-30px mb-lm-30px">
                    ...
                    <div class="single-feature">
                        <div class="feature-icon">
                            <img src="{{ asset('site/images/icons/1.png') }}" alt="">
                        </div>
                ...
                <div class="single-feture-col mb-md-30px mb-lm-30px">
                    <div class="single-feature">
                        <div class="feature-icon">
                            <img src="{{ asset('site/images/icons/2.png') }}" alt="">
                        </div>
                        <div class="feature-content">
                ...
                <div class="single-feture-col">
                    <div class="single-feature">
                        <div class="feature-icon">
                            <img src="{{ asset('site/images/icons/3.png') }}" alt="">
                        </div>
                        <div class="feature-content">
                                    ...
                                    <div class="testi-author">
                                        <div class="author-image">
                                            <img class="img-responsive"
                                                src="{{ asset('site/images/testimonial/1.png') }}" alt="">
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="testi-inner">
                                    ...
                                    <div class="testi-author">
                                        <div class="author-image">
                                            <img class="img-responsive"
                                                src="{{ asset('site/images/testimonial/2.png') }}" alt="">
                                        </div>
                                        <div class="author-name">
                                            <h4 class="name">Regan Rosen<span>Client</span></h4>
                                        </div>
            ...
            <div class="row">
                    ...
                    <div class="single-blog">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img
                                    src="{{ asset('site/images/blog-image/1.webp') }}" class="img-responsive w-100"
                                    alt=""></a>
                        </div>
                        <div class="blog-text">
                            ...
                            <h5 class="blog-heading"><a class="blog-heading-link"
                                    href="blog-single-left-sidebar.html">Lorem ipsum dolor sit amet conse adip</a>
                            </h5>
                ...
                <div class="col-lg-6 col-sm-6">
                    <div class="single-blog">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img
                                    src="{{ asset('site/images/blog-image/2.webp') }}" class="img-responsive w-100"
                                    alt=""></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-athor-date line-height-1">
