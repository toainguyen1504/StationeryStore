                        ...
                        <div class="single-product-slider-wrapper d-flex flex-wrap">
                            <div class="single-product-slider-item" data-aos="fade-up" data-aos-delay="200">
                                <a class="venobox" data-gall="myGallery"
                                    href="{{ asset('site/images/product-image/zoom-image/1.webp') }}"><img
                                        class="img-responsive" src="{{ asset('site/images/product-image/1.webp') }}"
                                        alt="slider-item-img"></a>
                            </div>
                            <div class="single-product-slider-item swiper-slide" data-aos="fade-up" data-aos-delay="400">
                                <a class="venobox" data-gall="myGallery"
                                    href="{{ asset('site/images/product-image/zoom-image/5.webp') }}"><img
                                        class="img-responsive" src="{{ asset('site/images/product-image/2.webp') }}"
                                        alt="slider-item-img"></a>
                            </div>
                            <div class="single-product-slider-item swiper-slide" data-aos="fade-up" data-aos-delay="200">
                                <a class="venobox" data-gall="myGallery"
                                    href="{{ asset('site/images/product-image/zoom-image/4.webp') }}"><img
                                        class="img-responsive" src="{{ asset('site/images/product-image/3.webp') }}"
                                        alt="slider-item-img"></a>
                            </div>
                            <div class="single-product-slider-item swiper-slide" data-aos="fade-up" data-aos-delay="400">
                                <a class="venobox" data-gall="myGallery"
                                    href="{{ asset('site/images/product-image/zoom-image/2.webp') }}"><img
                                        class="img-responsive" src="{{ asset('site/images/product-image/4.webp') }}"
                                        alt="slider-item-img"></a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="review-wrapper">
                                            <div class="single-review">
                                                <div class="review-img">
                                                    <img src="{{ asset('site/images/review-image/1.png') }}"
                                                        alt="" />
                                                </div>
                                            ...
                                            <div class="single-review child-review">
                                                <div class="review-img">
                                                    <img src="{{ asset('site/images/review-image/2.png') }}"
                                                        alt="" />
                                                </div>
                                                <div class="review-content">
                                                    <div class="review-top-wrap">
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="product">
                                    ...
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{ asset('site/images/product-image/1.webp') }}" alt="Product" />
                                            <img class="hover-image"
                                                src="{{ asset('site/images/product-image/1.webp') }}" alt="Product" />
                                        </a>
                                    </div>
                                    <div class="content">
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="product">
                                    ...
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{ asset('site/images/product-image/2.webp') }}" alt="Product" />
                                            <img class="hover-image"
                                                src="{{ asset('site/images/product-image/2.webp') }}" alt="Product" />
                                        </a>
                                    </div>
                                    <div class="content">
                                        <span class="category"><a href="#">Accessories</a></span>
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="product">
                                    ...
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{ asset('site/images/product-image/3.webp') }}" alt="Product" />
                                            <img class="hover-image"
                                                src="{{ asset('site/images/product-image/3.webp') }}" alt="Product" />
                                        </a>
                                    </div>
                                    <div class="content">
                                        <span class="category"><a href="#">Accessories</a></span>
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="product">
                                    ...
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{ asset('site/images/product-image/4.webp') }}" alt="Product" />
                                            <img class="hover-image"
                                                src="{{ asset('site/images/product-image/1.webp') }}" alt="Product" />
                                        </a>
                                    </div>
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="product">
                                    ...
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{ asset('site/images/product-image/5.webp') }}" alt="Product" />
                                            <img class="hover-image"
                                                src="{{ asset('site/images/product-image/5.webp') }}" alt="Product" />
                                        </a>
                                    </div>
                                    <div class="content">
                                        <span class="category"><a href="#">Accessories</a></span>
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="product">
                                    ...
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{ asset('site/images/product-image/6.webp') }}" alt="Product" />
                                            <img class="hover-image"
                                                src="{{ asset('site/images/product-image/6.webp') }}" alt="Product" />
                                        </a>
                                    </div>
                                    <div class="content">
                                        <span class="category"><a href="#">Accessories</a></span>
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="product">
                                    ...
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{ asset('site/images/product-image/7.webp') }}" alt="Product" />
                                            <img class="hover-image"
                                                src="{{ asset('site/images/product-image/1.webp') }}" alt="Product" />
                                        </a>
                                    </div>
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="product">
                                    ...
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{ asset('site/images/product-image/8.webp') }}" alt="Product" />
                                            <img class="hover-image"
                                                src="{{ asset('site/images/product-image/8.webp') }}" alt="Product" />
                                        </a>
                                    </div>
                                    <div class="content">
                                        <span class="category"><a href="#">Accessories</a></span>
