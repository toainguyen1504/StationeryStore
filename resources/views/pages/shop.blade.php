                                        ...
                                        <div class="row mb-n-30px">
                                                ...
                                                <div class="product">
                                                    ...
                                                    <div class="thumb">
                                                        <a href="single-product.html" class="image">
                                                            <img src="{{ asset('site/images/product-image/1.webp') }}"
                                                                alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('site/images/product-image/1.webp') }}"
                                                                alt="Product" />
                                                        </a>
                                                    </div>
                                                    <div class="content">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                                ...
                                                <div class="product">
                                                    ...
                                                    <div class="thumb">
                                                        <a href="single-product.html" class="image">
                                                            <img src="{{ asset('site/images/product-image/2.webp') }}"
                                                                alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('site/images/product-image/2.webp') }}"
                                                                alt="Product" />
                                                        </a>
                                                    </div>
                                                    <div class="content">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                                ...
                                                <div class="product">
                                                    ...
                                                    <div class="thumb">
                                                        <a href="single-product.html" class="image">
                                                            <img src="{{ asset('site/images/product-image/3.webp') }}"
                                                                alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('site/images/product-image/3.webp') }}"
                                                                alt="Product" />
                                                        </a>
                                                    </div>
                                                    <div class="content">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                                ...
                                                <div class="product">
                                                    ...
                                                    <div class="thumb">
                                                        <a href="single-product.html" class="image">
                                                            <img src="{{ asset('site/images/product-image/4.webp') }}"
                                                                alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('site/images/product-image/1.webp') }}"
                                                                alt="Product" />
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                                ...
                                                <div class="product">
                                                    ...
                                                    <div class="thumb">
                                                        <a href="single-product.html" class="image">
                                                            <img src="{{ asset('site/images/product-image/5.webp') }}"
                                                                alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('site/images/product-image/5.webp') }}"
                                                                alt="Product" />
                                                        </a>
                                                    </div>
                                                    <div class="content">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                                ...
                                                <div class="product">
                                                    ...
                                                    <div class="thumb">
                                                        <a href="single-product.html" class="image">
                                                            <img src="{{ asset('site/images/product-image/6.webp') }}"
                                                                alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('site/images/product-image/6.webp') }}"
                                                                alt="Product" />
                                                        </a>
                                                    </div>
                                                    <div class="content">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                                ...
                                                <div class="product">
                                                    ...
                                                    <div class="thumb">
                                                        <a href="single-product.html" class="image">
                                                            <img src="{{ asset('site/images/product-image/7.webp') }}"
                                                                alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('site/images/product-image/1.webp') }}"
                                                                alt="Product" />
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                                ...
                                                <div class="product">
                                                    ...
                                                    <div class="thumb">
                                                        <a href="single-product.html" class="image">
                                                            <img src="{{ asset('site/images/product-image/8.webp') }}"
                                                                alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('site/images/product-image/8.webp') }}"
                                                                alt="Product" />
                                                        </a>
                                                    </div>
                                                    <div class="content">
                                                    ...
                                                    <div class="thumb">
                                                        <a href="single-product.html" class="image">
                                                            <img src="{{ asset('site/images/product-image/4.webp') }}"
                                                                alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('site/images/product-image/4.webp') }}"
                                                                alt="Product" />
                                                        </a>
                                                    </div>
                                                    <div class="content">
                                                        ...
                                                        <div class="thumb">
                                                            <a href="single-product.html" class="image">
                                                                <img src="{{ asset('site/images/product-image/7.webp') }}"
                                                                    alt="Product" />
                                                                <img class="hover-image"
                                                                    src="{{ asset('site/images/product-image/7.webp') }}"
                                                                    alt="Product" />
                                                            </a>
                                                            <span class="badges">
                                                                <span class="sale">-10%</span>
